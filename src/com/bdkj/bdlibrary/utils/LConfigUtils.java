...
public class LConfigUtils {
    /**
     * 默认获取{@link android.content.SharedPreferences}时的flag
     */
    private final static int PREFERENCES_MODE = Context.MODE_PRIVATE;

    /**
     * 调用{@link #getInt(android.content.Context, String)}时默认的值
     * <p>{@link #getInt(android.content.Context, String)}如果传入的key不存在，返回{@link #INT_PREFERENCES_DEFAULT_VALUE}</p>
     */
    private final static int INT_PREFERENCES_DEFAULT_VALUE = 0;

    /**
     * 调用{@link #getLong(android.content.Context, String)}时的默认值
     */
    private final static long LONG_PREFERENCES_DEFAULT_VALUE = 0;

    /**
     * 调用{@link #getFloat(android.content.Context, String)}时的默认值
     */
    private final static float FLOAT_PREFERENCES_DEFAULT_VALUE = 0f;

    /**
     * 调用{@link #getBoolean(android.content.Context, String)}时的默认值
     */
    private final static boolean BOOLEAN_PREFERENCES_DEFAULT_VALUE = false;

    /**
     * 调用{@link #getString(android.content.Context, String)}时的默认值
     */
    private final static String STRING_PREFERENCES_DEFAULT_VALUE = "";

    /**
     * 分隔SharedPreferences的配置文件名与字段,默认用'.'号分隔文件名与字段
     * {@link android.content.Context#getSharedPreferences(String, int)}第一个参数表示为NAME
     * {@link android.content.SharedPreferences.Editor#putInt(String, int)}第一个参数表示为KEY
     * <pre>
     ...
     * <p>如果传入的name_key参数为空或不是按指定格式定义则抛出{@link java.lang.RuntimeException}</p>
     *
     * @param context  上下文
    ...
    /**
     * 调用{@link #setInt(android.content.Context, String, int, int)},传入默认的数据获取模式{@link #PREFERENCES_MODE}
     *
     * @param context  上下文
     * @param name_key 配置文件_关键词
     * @param value    关键词的值
    ...
    /**
     * 调用{@link #getInt(android.content.Context, String, int, int)}从SharedPreferences中获取一个int数
    ...
    /**
     * 调用{@link #getInt(android.content.Context, String, int)}从SharedPreferences中获取一个int数
     * <p>默认的mode为{@link #PREFERENCES_MODE}</p>
    ...
    /**
     * 调用{@link #setLong(android.content.Context, String, long, int)}设置长整型的SharedPreferences
    ...
    /**
     * 调用{@link #getLong(android.content.Context, String, long, int)}从配置文件中获取指定字段名的长整型值
    ...
    /**
     * 调用{@link #getLong(android.content.Context, String, long)}从配置文件中获取指定字段名的长整型值
     * <p>指定获取的方式为私有的{@link #PREFERENCES_MODE}</p>
    ...
    /**
     * 调用{@link #setBoolean(android.content.Context, String, boolean, int)}设置布尔型的SharedPreferences
    ...
    /**
     * 调用{@link #getBoolean(android.content.Context, String, boolean, int)}从配置文件中获取指定字段名的布尔值
    ...
    /**
     * 调用{@link #getBoolean(android.content.Context, String, boolean)}从配置文件中获取指定字段名的布尔值
     * 指定默认的获取模式{@link #PREFERENCES_MODE}
    ...
    /**
     * 调用{@link #setFloat(android.content.Context, String, float, int)}设置浮点型的SharedPreferences
     * 指定默认的获取模式{@link #PREFERENCES_MODE}
     *
     * @param context  上下文
     * @param name_key 配置文件_关键词
    ...
    /**
     * 调用{@link #getFloat(android.content.Context, String, float, int)}从配置文件中获取指定字段名的浮点型值
     * 指定默认的获取模式{@link #PREFERENCES_MODE}
     *
     * @param context      上下文
     * @param name_key     配置文件名_关键词
    ...
    /**
     * 调用{@link #getFloat(android.content.Context, String, float)}从配置文件中获取指定字段名的浮点型值
     * 指定默认的获取模式{@link #PREFERENCES_MODE}
    ...
    /**
     * 清空配置文件中的所有值
     * <p>调用{@link #clearPreferences(android.content.Context, String, int)}</p>
