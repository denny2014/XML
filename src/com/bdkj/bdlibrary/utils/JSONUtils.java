...
public class JSONUtils {
     ...
     * <pre>
     *     fromJson("") = new IMap();
     *     fromJson("[{'aaa':'bbb'}] = return {@link #fromJson(org.json.JSONObject)}
     *     fromJson("{'aaa':'bbb'} = return {@link #fromJson(org.json.JSONObject)}
     * </pre>
     *
     ...
     *
     * @param json 有效的{@link org.json.JSONObject}对象
     * @return
     * @throws JSONException 当传入的{@link org.json.JSONObject}是无效的则抛出{@link org.json.JSONException}
     */
    ...
    /**
     * Map对象转换成{@link org.json.JSONObject}对象
     *
     * @param map Map对象
     * @return
     * @throws JSONException
